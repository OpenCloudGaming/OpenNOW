    ...
    function settingsModel() {
        ...
        if (root.selectedSection === 1) {
            ...
            return [
                ...
                {t:"Max bitrate", d:"Maximum requested stream bitrate", v:Number(settings.maxBitrateMbps || 75) + " Mbps", key:"maxBitrateMbps", values:[0.22,1,5,10,25,50,75,100], labels:["0.22 Mbps","1 Mbps","5 Mbps","10 Mbps","25 Mbps","50 Mbps","75 Mbps","100 Mbps"], control:"slider", sliderPercent:Number(settings.maxBitrateMbps || 75) / 100},
