...
class TenBitWarningTestSetup final : public QObject
{
    Q_OBJECT
...
public slots:
    void applicationAvailable()
    {
        ...
        qmlRegisterType(QUrl::fromLocalFile(source + "/components/TenBitWarningDialog.qml"), "OpenNOW", 1, 0, "TenBitWarningDialog");
...
QUICK_TEST_MAIN_WITH_SETUP(tenbitwarning, TenBitWarningTestSetup)
#include "tst_tenbitwarning.moc"
