...
import type { StreamDiagnostics, StreamLagReason, StreamTimeWarning } from "./webrtc/streamDiagnosticsTypes";
export type { StreamDiagnostics, StreamLagReason, StreamTimeWarning };
import {
  chooseAdaptiveMouseFlushInterval,
  quantizeMouseDeltaWithResidual,
  MouseDeltaFilter,
  type AdaptiveMouseFlushDecisionParams,
} from "./webrtc/mouseFlush";
export { chooseAdaptiveMouseFlushInterval, quantizeMouseDeltaWithResidual };
export type { AdaptiveMouseFlushDecisionParams };
import {
  hevcPreferredProfileId,
  timestampUs,
  parseRiInputCapabilities,
  clampRumbleMagnitude,
  isXboxLikeGamepad,
  getGamepadRumbleApi,
  parseResolution,
  toRtcIceServers,
  ...
  type ConnectedRumbleGamepad,
  type GamepadRumbleApi,
} from "./webrtc/clientUtils";
